...
public class IotHubX509SoftwareIotHubAuthenticationProviderTest
{
    ...
    @Test
    public void getSSLContextGets() throws CertificateException, UnrecoverableKeyException, NoSuchAlgorithmException, IOException, KeyManagementException, KeyStoreException, TransportException, SecurityProviderException
    {
        //arrange
        new NonStrictExpectations()
        {
    ...
    @Test
    public void getSSLContextSuccess() throws IOException, TransportException, SecurityProviderException
    {
        //arrange
        IotHubAuthenticationProvider authentication = new IotHubX509SoftwareAuthenticationProvider(hostname, gatewayHostname, deviceId, moduleId, publicKeyCertificate, false, privateKey, false);

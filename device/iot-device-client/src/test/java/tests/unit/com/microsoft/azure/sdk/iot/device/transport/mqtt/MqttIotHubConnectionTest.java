...
public class MqttIotHubConnectionTest
{
    ...
    @Test
    public void receiveMessageSucceeds() throws IOException, TransportException, MqttException
    {
        baseExpectations();
        openExpectations(null);
        new NonStrictExpectations()
    ...
    @Test
    public void receiveDeviceTwinMessageSucceeds() throws IOException, TransportException, MqttException
    {
        baseExpectations();
        openExpectations(null);
        final byte[] expectedMessageBody = { 0x61, 0x62, 0x63 };
    ...
    @Test
    public void receiveDeviceMethodMessageSucceeds() throws IOException, TransportException, MqttException
    {
        baseExpectations();
        openExpectations(null);
        final byte[] expectedMessageBody = { 0x61, 0x62, 0x63 };
    ...
    public void openSavesListenerToMessagingClient() throws IOException, TransportException
    {
        ...
        {
            {
                new MqttMessaging((MqttAsyncClient) any, anyString, null, anyString, anyBoolean, (MqttConnectOptions) any);
                times = 1;
            }
        };
    }
        ...
        {
            {
                ...
                new MqttMessaging(mockedMqttConnection, anyString, null, anyString, anyBoolean, (MqttConnectOptions) any);
                result = mockDeviceMessaging;
                new MqttDeviceTwin(mockedMqttConnection, anyString, (MqttConnectOptions) any);
                result = mockDeviceTwin;
                new MqttDeviceMethod(mockedMqttConnection, anyString, (MqttConnectOptions) any);

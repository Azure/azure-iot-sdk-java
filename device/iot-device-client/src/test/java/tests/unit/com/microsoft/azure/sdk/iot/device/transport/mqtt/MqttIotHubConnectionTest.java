...
public class MqttIotHubConnectionTest
{
    ...
    final String API_VERSION = "?api-version=" + TransportUtils.IOTHUB_API_VERSION;
    final String PNP_API_VERSION = "?api-version=" + TransportUtils.PNP_IOTHUB_API_VERSION + "&digital-twin-model-id=" + modelId;

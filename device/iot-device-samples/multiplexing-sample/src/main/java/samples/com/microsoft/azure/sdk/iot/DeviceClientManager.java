...
public class DeviceClientManager implements IotHubConnectionStatusChangeCallback {
    ...
    public String getDeviceId(){
        return this.client.getConfig().getDeviceId();
    }
    ...
    public void execute(IotHubConnectionStatus status, IotHubConnectionStatusChangeReason statusChangeReason, Throwable throwable, Object callbackContext) {
        ...
        DeviceClientManager clientManager = (DeviceClientManager) callbackContext;
        if (throwable == null)
        {
            System.out.println("CONNECTION STATUS UPDATE FOR DEVICE " + clientManager.getDeviceId() + " - " + status + ", " + statusChangeReason);
        }
        else
        {
            System.out.println("CONNECTION STATUS UPDATE FOR DEVICE " + clientManager.getDeviceId() + " - " + status + ", " + statusChangeReason + ", " + throwable.getMessage());
        }

...
public interface DeviceClientLonghaulTestAddOn
{
    /**
     ...
     */
    void setupClientBeforeOpen(DeviceClientManager clientUnderTest, ServiceClient serviceClient, RegistryManager registryManager, TestParameters testParameters) throws Exception;
     ...
     */
    void setupClientAfterOpen(DeviceClientManager clientUnderTest, ServiceClient serviceClient, RegistryManager registryManager, TestParameters testParameters) throws Exception;
    ...
    /**
     * Callback that is executed by the longhaul test periodically to allow for some testable action to be run.
     * For example, sending d2c telemetry, receive a direct method, etc.
     */
    void performPeriodicTestableAction(DeviceClientManager clientUnderTest, ServiceClient serviceClient, RegistryManager registryManager, TestParameters testParameters) throws Exception;

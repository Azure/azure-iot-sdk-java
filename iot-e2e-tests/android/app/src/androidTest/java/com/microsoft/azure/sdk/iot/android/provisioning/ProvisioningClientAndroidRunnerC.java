...
public class ProvisioningClientAndroidRunnerC extends ProvisioningTests
{
    @Rule
    public ReportHelper reportHelper = Factory.getReportHelper();

    public ProvisioningClientAndroidRunnerC(ProvisioningDeviceClientTransportProtocol protocol, AttestationType attestationType)
    {
    ...
    public static Collection inputs() throws Exception
    {
        ...
        return ProvisioningCommon.inputs(false, false, true); //tpm tests can't be run on Android until infrastructure is setup
    }

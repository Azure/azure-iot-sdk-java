...
public class DesiredPropertiesErrInjDeviceThingsRunner extends DesiredPropertiesErrInjTests
{
    ...
    public DesiredPropertiesErrInjDeviceThingsRunner(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {

...
public class DeviceMethodErrInjModuleThingsRunner extends DeviceMethodErrInjTests
{
    ...
    public DeviceMethodErrInjModuleThingsRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) throws Exception {

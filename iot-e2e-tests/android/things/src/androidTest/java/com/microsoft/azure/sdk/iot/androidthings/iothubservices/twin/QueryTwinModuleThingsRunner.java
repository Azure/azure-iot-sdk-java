...
public class QueryTwinModuleThingsRunner extends QueryTwinTests
{
    ...
    public QueryTwinModuleThingsRunner(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {

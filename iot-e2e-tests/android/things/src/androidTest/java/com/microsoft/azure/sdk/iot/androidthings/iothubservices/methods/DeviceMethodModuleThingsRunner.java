...
public class DeviceMethodModuleThingsRunner extends DeviceMethodTests
{
    ...
    public DeviceMethodModuleThingsRunner(DeviceTestManager deviceTestManager, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, BaseDevice identity, String publicKeyCert, String privateKey, String x509Thumbprint)
    {

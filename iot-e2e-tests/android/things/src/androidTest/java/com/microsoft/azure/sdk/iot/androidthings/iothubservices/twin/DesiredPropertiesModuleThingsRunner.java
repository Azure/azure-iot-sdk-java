...
public class DesiredPropertiesModuleThingsRunner extends DesiredPropertiesTests
{
    ...
    public DesiredPropertiesModuleThingsRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) {

...
public class QueryTwinDeviceThingsRunner extends QueryTwinTests
{
    ...
    public QueryTwinDeviceThingsRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) {

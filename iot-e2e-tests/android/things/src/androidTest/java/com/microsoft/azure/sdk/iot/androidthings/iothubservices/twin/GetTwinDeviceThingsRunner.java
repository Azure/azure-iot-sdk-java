...
public class GetTwinDeviceThingsRunner extends GetTwinTests
{
    ...
    public GetTwinDeviceThingsRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) {

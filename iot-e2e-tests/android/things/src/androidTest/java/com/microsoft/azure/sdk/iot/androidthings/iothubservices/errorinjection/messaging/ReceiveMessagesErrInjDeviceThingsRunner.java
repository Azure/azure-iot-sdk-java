...
public class ReceiveMessagesErrInjDeviceThingsRunner extends ReceiveMessagesErrInjTests
{
    ...
    public ReceiveMessagesErrInjDeviceThingsRunner(InternalClient client, IotHubClientProtocol protocol, BaseDevice identity, AuthenticationType authenticationType, String clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {

...
public class ReportedPropertiesErrInjModuleThingsRunner extends ReportedPropertiesErrInjTests
{
    ...
    public ReportedPropertiesErrInjModuleThingsRunner(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {

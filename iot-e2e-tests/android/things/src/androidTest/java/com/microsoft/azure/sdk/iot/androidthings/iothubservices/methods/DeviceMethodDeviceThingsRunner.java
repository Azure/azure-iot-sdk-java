...
public class DeviceMethodDeviceThingsRunner extends DeviceMethodTests
{
    ...
    public DeviceMethodDeviceThingsRunner(DeviceTestManager deviceTestManager, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, BaseDevice identity, String publicKeyCert, String privateKey, String x509Thumbprint)
    {

...
public class DeviceMethodDeviceThingsRunner extends DeviceMethodTests
{
    ...
    public DeviceMethodDeviceThingsRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) throws Exception {

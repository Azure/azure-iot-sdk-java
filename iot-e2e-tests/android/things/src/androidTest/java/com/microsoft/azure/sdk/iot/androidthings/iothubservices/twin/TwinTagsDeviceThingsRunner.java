...
public class TwinTagsDeviceThingsRunner extends TwinTagsTests
{
    ...
    public TwinTagsDeviceThingsRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) {

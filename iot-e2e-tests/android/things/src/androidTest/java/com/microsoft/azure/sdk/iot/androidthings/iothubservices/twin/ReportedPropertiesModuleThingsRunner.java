...
public class ReportedPropertiesModuleThingsRunner extends ReportedPropertiesTests
{
    ...
    public ReportedPropertiesModuleThingsRunner(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {

...
public class ReceiveMessagesModuleThingsRunner extends ReceiveMessagesTests
{
    ...
    public ReceiveMessagesModuleThingsRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) throws Exception {

...
public class ReportedPropertiesErrInjDeviceThingsRunner extends ReportedPropertiesErrInjTests
{
    ...
    public ReportedPropertiesErrInjDeviceThingsRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) {

...
public class ReceiveMessagesErrInjModuleThingsRunner extends ReceiveMessagesErrInjTests
{
    ...
    public ReceiveMessagesErrInjModuleThingsRunner(InternalClient client, IotHubClientProtocol protocol, BaseDevice identity, AuthenticationType authenticationType, String clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {

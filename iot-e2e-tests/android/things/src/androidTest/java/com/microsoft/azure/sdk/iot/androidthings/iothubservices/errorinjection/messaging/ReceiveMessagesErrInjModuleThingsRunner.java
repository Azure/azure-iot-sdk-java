...
public class ReceiveMessagesErrInjModuleThingsRunner extends ReceiveMessagesErrInjTests
{
    ...
    public ReceiveMessagesErrInjModuleThingsRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) throws Exception {

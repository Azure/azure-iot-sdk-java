...
public class SendMessagesModuleThingsRunner extends SendMessagesTests
{
    ...
    public SendMessagesModuleThingsRunner(IotHubClientProtocol protocol, AuthenticationType authenticationType, ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint, boolean useHttpProxy) throws Exception
    {

...
public class SendMessagesModuleThingsRunner extends SendMessagesTests
{
    ...
    public SendMessagesModuleThingsRunner(InternalClient client, IotHubClientProtocol protocol, BaseDevice identity, AuthenticationType authenticationType, String clientType, String publicKeyCert, String privateKey, String x509Thumbprint)
    {

...
public interface DigitalTwinServiceClient {
     ...
     * @return The json string specifying the state of the full digital twin, including all properties of all interface instances registered by that digital twin
     */
    String getDigitalTwin(@NonNull String digitalTwinId);
     ...
     * @return The DigitalTwin model definition
     */
    String getModel(@NonNull String modelId, boolean expand);

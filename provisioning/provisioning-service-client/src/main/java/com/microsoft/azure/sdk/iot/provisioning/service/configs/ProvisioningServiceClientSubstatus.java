...
public enum ProvisioningServiceClientSubstatus
{
    ...
    ProvisioningServiceClientSubstatus(String substatus)
    {
    ...
    public static ProvisioningServiceClientSubstatus fromString(String substatus)
    {
        for (ProvisioningServiceClientSubstatus substatusCode : ProvisioningServiceClientSubstatus.values())
        {

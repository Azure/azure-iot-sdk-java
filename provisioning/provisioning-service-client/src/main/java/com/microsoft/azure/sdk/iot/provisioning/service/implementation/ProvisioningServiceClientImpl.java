...
public class ProvisioningServiceClientImpl extends ServiceClient implements ProvisioningServiceClient
{
	 ...
	 * Initializes an instance of ProvisioningServiceClient client.
	 *
	 * @param clientBuilder the builder for building an OkHttp client, bundled with
	 *                      user configurations
	 * @param restBuilder   the builder for building an Retrofit client, bundled
	 ...
	 *                      with user configurations
	 */
	public ProvisioningServiceClientImpl(String baseUrl, OkHttpClient.Builder clientBuilder,
	...
	interface ProvisioningServiceClientService
	{
		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient getIndividualEnrollment" })
		@GET("enrollments/{id}")
		Observable<Response<ResponseBody>> getIndividualEnrollment(@Path("id") String id,
				@Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient createOrUpdateIndividualEnrollment" })
		@PUT("enrollments/{id}")
		Observable<Response<ResponseBody>> createOrUpdateIndividualEnrollment(@Path("id") String id,
				@Body IndividualEnrollment enrollment, @Header("If-Match") String ifMatch,
				@Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient deleteIndividualEnrollment" })
		@HTTP(path = "enrollments/{id}", method = "DELETE", hasBody = true)
		Observable<Response<ResponseBody>> deleteIndividualEnrollment(@Path("id") String id,
				@Header("If-Match") String ifMatch, @Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient getEnrollmentGroup" })
		@GET("enrollmentGroups/{id}")
		Observable<Response<ResponseBody>> getEnrollmentGroup(@Path("id") String id,
				@Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient createOrUpdateEnrollmentGroup" })
		@PUT("enrollmentGroups/{id}")
		Observable<Response<ResponseBody>> createOrUpdateEnrollmentGroup(@Path("id") String id,
				@Body EnrollmentGroup enrollmentGroup, @Header("If-Match") String ifMatch,
				@Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient deleteEnrollmentGroup" })
		@HTTP(path = "enrollmentGroups/{id}", method = "DELETE", hasBody = true)
		Observable<Response<ResponseBody>> deleteEnrollmentGroup(@Path("id") String id,
				@Header("If-Match") String ifMatch, @Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient getDeviceRegistrationState" })
		@GET("registrations/{id}")
		Observable<Response<ResponseBody>> getDeviceRegistrationState(@Path("id") String id,
				@Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient deleteDeviceRegistrationState" })
		@HTTP(path = "registrations/{id}", method = "DELETE", hasBody = true)
		Observable<Response<ResponseBody>> deleteDeviceRegistrationState(@Path("id") String id,
				@Header("If-Match") String ifMatch, @Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient runBulkEnrollmentOperation" })
		@POST("enrollments")
		Observable<Response<ResponseBody>> runBulkEnrollmentOperation(@Body BulkEnrollmentOperation bulkOperation,
				@Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient queryIndividualEnrollments" })
		@POST("enrollments/query")
		Observable<Response<ResponseBody>> queryIndividualEnrollments(
				@Header("x-ms-max-item-count") Integer xMsMaxItemCount,
				@Header("x-ms-continuation") String xMsContinuation, @Body QuerySpecification querySpecification,
				@Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient getIndividualEnrollmentAttestationMechanism" })
		@POST("enrollments/{id}/attestationmechanism")
		Observable<Response<ResponseBody>> getIndividualEnrollmentAttestationMechanism(@Path("id") String id,
				@Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient queryEnrollmentGroups" })
		@POST("enrollmentGroups/query")
		Observable<Response<ResponseBody>> queryEnrollmentGroups(@Header("x-ms-max-item-count") Integer xMsMaxItemCount,
				@Header("x-ms-continuation") String xMsContinuation, @Body QuerySpecification querySpecification,
				@Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient getEnrollmentGroupAttestationMechanism" })
		@POST("enrollmentGroups/{id}/attestationmechanism")
		Observable<Response<ResponseBody>> getEnrollmentGroupAttestationMechanism(@Path("id") String id,
				@Query("api-version") String apiVersion);

		@Headers({ "Content-Type: application/json; charset=utf-8",
				"x-ms-logging-context: com.microsoft.azure.sdk.iot.provisioning.service.ProvisioningServiceClient queryDeviceRegistrationStates" })
		@POST("registrations/{id}/query")
		Observable<Response<ResponseBody>> queryDeviceRegistrationStates(@Path("id") String id,
				@Query("api-version") String apiVersion);
	 ...
	 */
	public ServiceFuture<IndividualEnrollment> getIndividualEnrollmentAsync(String id,
	...
	{
		return getIndividualEnrollmentWithServiceResponseAsync(id)
				.map(new Func1<ServiceResponse<IndividualEnrollment>, IndividualEnrollment>()
				{
					@Override
		...
		return service.getIndividualEnrollment(id, this.apiVersion())
				.flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<IndividualEnrollment>>>()
				{
					...
					public Observable<ServiceResponse<IndividualEnrollment>> call(Response<ResponseBody> response)
					{
						try
						{
							ServiceResponse<IndividualEnrollment> clientResponse = getIndividualEnrollmentDelegate(
									response);
	...
	private ServiceResponse<IndividualEnrollment> getIndividualEnrollmentDelegate(Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<IndividualEnrollment, ProvisioningServiceErrorDetailsException>newInstance(this.serializerAdapter())
				.register(200, new TypeToken<IndividualEnrollment>()
				{
				}.getType()).registerError(ProvisioningServiceErrorDetailsException.class).build(response);
	}
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<IndividualEnrollment> createOrUpdateIndividualEnrollmentAsync(String id,
			IndividualEnrollment enrollment, final ServiceCallback<IndividualEnrollment> serviceCallback)
	{
		return ServiceFuture.fromResponse(createOrUpdateIndividualEnrollmentWithServiceResponseAsync(id, enrollment),
				serviceCallback);
	}
	 ...
	 * @return the observable to the IndividualEnrollment object
	 */
	public Observable<IndividualEnrollment> createOrUpdateIndividualEnrollmentAsync(String id,
			IndividualEnrollment enrollment)
	{
		return createOrUpdateIndividualEnrollmentWithServiceResponseAsync(id, enrollment)
				.map(new Func1<ServiceResponse<IndividualEnrollment>, IndividualEnrollment>()
				{
					@Override
					public IndividualEnrollment call(ServiceResponse<IndividualEnrollment> response)
	 ...
	 * @return the observable to the IndividualEnrollment object
	 */
	public Observable<ServiceResponse<IndividualEnrollment>> createOrUpdateIndividualEnrollmentWithServiceResponseAsync(
		...
		return service.createOrUpdateIndividualEnrollment(id, enrollment, ifMatch, this.apiVersion())
				.flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<IndividualEnrollment>>>()
				{
					...
					public Observable<ServiceResponse<IndividualEnrollment>> call(Response<ResponseBody> response)
					{
						try
						{
							ServiceResponse<IndividualEnrollment> clientResponse = createOrUpdateIndividualEnrollmentDelegate(
									response);
							return Observable.just(clientResponse);
						}
						catch (Throwable t)
	...
	public IndividualEnrollment createOrUpdateIndividualEnrollment(String id, IndividualEnrollment enrollment,
			String ifMatch)
	{
		return createOrUpdateIndividualEnrollmentWithServiceResponseAsync(id, enrollment, ifMatch).toBlocking().single()
				.body();
	}
			...
			final ServiceCallback<IndividualEnrollment> serviceCallback)
	{
		return ServiceFuture.fromResponse(
				createOrUpdateIndividualEnrollmentWithServiceResponseAsync(id, enrollment, ifMatch), serviceCallback);
	}
	...
	public Observable<IndividualEnrollment> createOrUpdateIndividualEnrollmentAsync(String id,
			IndividualEnrollment enrollment, String ifMatch)
	{
		return createOrUpdateIndividualEnrollmentWithServiceResponseAsync(id, enrollment, ifMatch)
				.map(new Func1<ServiceResponse<IndividualEnrollment>, IndividualEnrollment>()
				{
					@Override
					public IndividualEnrollment call(ServiceResponse<IndividualEnrollment> response)
	...
	private ServiceResponse<IndividualEnrollment> createOrUpdateIndividualEnrollmentDelegate(
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<Void> deleteIndividualEnrollmentAsync(String id, String ifMatch,
			final ServiceCallback<Void> serviceCallback)
	{
		return ServiceFuture.fromResponse(deleteIndividualEnrollmentWithServiceResponseAsync(id, ifMatch),
				serviceCallback);
	}
	...
	{
		return deleteIndividualEnrollmentWithServiceResponseAsync(id, ifMatch)
	...
	private ServiceResponse<Void> deleteIndividualEnrollmentDelegate(Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<Void, ProvisioningServiceErrorDetailsException>newInstance(this.serializerAdapter())
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<EnrollmentGroup> getEnrollmentGroupAsync(String id,
	...
	{
		return getEnrollmentGroupWithServiceResponseAsync(id)
				.map(new Func1<ServiceResponse<EnrollmentGroup>, EnrollmentGroup>()
				{
					@Override
	...
	private ServiceResponse<EnrollmentGroup> getEnrollmentGroupDelegate(Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<EnrollmentGroup, ProvisioningServiceErrorDetailsException>newInstance(this.serializerAdapter())
				.register(200, new TypeToken<EnrollmentGroup>()
				{
				}.getType()).registerError(ProvisioningServiceErrorDetailsException.class).build(response);
	}
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<EnrollmentGroup> createOrUpdateEnrollmentGroupAsync(String id, EnrollmentGroup enrollmentGroup,
			final ServiceCallback<EnrollmentGroup> serviceCallback)
	{
		return ServiceFuture.fromResponse(createOrUpdateEnrollmentGroupWithServiceResponseAsync(id, enrollmentGroup),
				serviceCallback);
	}
	...
	{
		return createOrUpdateEnrollmentGroupWithServiceResponseAsync(id, enrollmentGroup)
				.map(new Func1<ServiceResponse<EnrollmentGroup>, EnrollmentGroup>()
				{
					@Override
					public EnrollmentGroup call(ServiceResponse<EnrollmentGroup> response)
	 ...
	 * @return the observable to the EnrollmentGroup object
	 */
	public Observable<ServiceResponse<EnrollmentGroup>> createOrUpdateEnrollmentGroupWithServiceResponseAsync(String id,
		...
		return service.createOrUpdateEnrollmentGroup(id, enrollmentGroup, ifMatch, this.apiVersion())
				.flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<EnrollmentGroup>>>()
				{
					...
					public Observable<ServiceResponse<EnrollmentGroup>> call(Response<ResponseBody> response)
					{
						try
						{
							ServiceResponse<EnrollmentGroup> clientResponse = createOrUpdateEnrollmentGroupDelegate(
									response);
							return Observable.just(clientResponse);
						}
						catch (Throwable t)
	...
	{
		return createOrUpdateEnrollmentGroupWithServiceResponseAsync(id, enrollmentGroup, ifMatch).toBlocking().single()
				.body();
	}
	...
	{
		return ServiceFuture.fromResponse(
				createOrUpdateEnrollmentGroupWithServiceResponseAsync(id, enrollmentGroup, ifMatch), serviceCallback);
	}
	...
	public Observable<EnrollmentGroup> createOrUpdateEnrollmentGroupAsync(String id, EnrollmentGroup enrollmentGroup,
			String ifMatch)
	{
		return createOrUpdateEnrollmentGroupWithServiceResponseAsync(id, enrollmentGroup, ifMatch)
				.map(new Func1<ServiceResponse<EnrollmentGroup>, EnrollmentGroup>()
				{
					@Override
					public EnrollmentGroup call(ServiceResponse<EnrollmentGroup> response)
	...
	private ServiceResponse<EnrollmentGroup> createOrUpdateEnrollmentGroupDelegate(Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<EnrollmentGroup, ProvisioningServiceErrorDetailsException>newInstance(this.serializerAdapter())
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<Void> deleteEnrollmentGroupAsync(String id, String ifMatch,
			final ServiceCallback<Void> serviceCallback)
	{
	...
	private ServiceResponse<Void> deleteEnrollmentGroupDelegate(Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<Void, ProvisioningServiceErrorDetailsException>newInstance(this.serializerAdapter())
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<DeviceRegistrationState> getDeviceRegistrationStateAsync(String id,
	...
	{
		return getDeviceRegistrationStateWithServiceResponseAsync(id)
				.map(new Func1<ServiceResponse<DeviceRegistrationState>, DeviceRegistrationState>()
				{
					@Override
	 ...
	 * @return the observable to the DeviceRegistrationState object
	 */
	public Observable<ServiceResponse<DeviceRegistrationState>> getDeviceRegistrationStateWithServiceResponseAsync(
			String id)
	{
		if (id == null)
		{
		...
		return service.getDeviceRegistrationState(id, this.apiVersion())
				.flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<DeviceRegistrationState>>>()
				{
					...
					public Observable<ServiceResponse<DeviceRegistrationState>> call(Response<ResponseBody> response)
					{
						try
						{
							ServiceResponse<DeviceRegistrationState> clientResponse = getDeviceRegistrationStateDelegate(
									response);
							return Observable.just(clientResponse);
						}
						catch (Throwable t)
	...
	private ServiceResponse<DeviceRegistrationState> getDeviceRegistrationStateDelegate(Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<DeviceRegistrationState, ProvisioningServiceErrorDetailsException>newInstance(
						this.serializerAdapter())
				.register(200, new TypeToken<DeviceRegistrationState>()
				{
				}.getType()).registerError(ProvisioningServiceErrorDetailsException.class).build(response);
	}
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<Void> deleteDeviceRegistrationStateAsync(String id,
			final ServiceCallback<Void> serviceCallback)
	{
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<Void> deleteDeviceRegistrationStateAsync(String id, String ifMatch,
			final ServiceCallback<Void> serviceCallback)
	{
		return ServiceFuture.fromResponse(deleteDeviceRegistrationStateWithServiceResponseAsync(id, ifMatch),
				serviceCallback);
	}
	...
	{
		return deleteDeviceRegistrationStateWithServiceResponseAsync(id, ifMatch)
				.map(new Func1<ServiceResponse<Void>, Void>()
				{
					@Override
					public Void call(ServiceResponse<Void> response)
	...
	private ServiceResponse<Void> deleteDeviceRegistrationStateDelegate(Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<Void, ProvisioningServiceErrorDetailsException>newInstance(this.serializerAdapter())
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<BulkEnrollmentOperationResult> runBulkEnrollmentOperationAsync(
			BulkEnrollmentOperation bulkOperation, final ServiceCallback<BulkEnrollmentOperationResult> serviceCallback)
	{
		return ServiceFuture.fromResponse(runBulkEnrollmentOperationWithServiceResponseAsync(bulkOperation),
				serviceCallback);
	}
	 ...
	 */
	public Observable<BulkEnrollmentOperationResult> runBulkEnrollmentOperationAsync(
			BulkEnrollmentOperation bulkOperation)
	{
		return runBulkEnrollmentOperationWithServiceResponseAsync(bulkOperation)
				.map(new Func1<ServiceResponse<BulkEnrollmentOperationResult>, BulkEnrollmentOperationResult>()
				{
					@Override
	 ...
	 * @return the observable to the BulkEnrollmentOperationResult object
	 */
	public Observable<ServiceResponse<BulkEnrollmentOperationResult>> runBulkEnrollmentOperationWithServiceResponseAsync(
			BulkEnrollmentOperation bulkOperation)
	{
		...
		return service.runBulkEnrollmentOperation(bulkOperation, this.apiVersion())
				...
				{
					@Override
					public Observable<ServiceResponse<BulkEnrollmentOperationResult>> call(
							Response<ResponseBody> response)
					{
						try
						{
							ServiceResponse<BulkEnrollmentOperationResult> clientResponse = runBulkEnrollmentOperationDelegate(
									response);
							return Observable.just(clientResponse);
						}
						catch (Throwable t)
	...
	private ServiceResponse<BulkEnrollmentOperationResult> runBulkEnrollmentOperationDelegate(
			Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<BulkEnrollmentOperationResult, ProvisioningServiceErrorDetailsException>newInstance(
						this.serializerAdapter())
				.register(200, new TypeToken<BulkEnrollmentOperationResult>()
				{
				}.getType()).registerError(ProvisioningServiceErrorDetailsException.class).build(response);
	}
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<List<IndividualEnrollment>> queryIndividualEnrollmentsAsync(
			QuerySpecification querySpecification, final ServiceCallback<List<IndividualEnrollment>> serviceCallback)
	{
		return ServiceFuture.fromHeaderResponse(queryIndividualEnrollmentsWithServiceResponseAsync(querySpecification),
				serviceCallback);
	}
	...
	{
		return queryIndividualEnrollmentsWithServiceResponseAsync(querySpecification).map(
				new Func1<ServiceResponseWithHeaders<List<IndividualEnrollment>, QueryIndividualEnrollmentsHeaders>, List<IndividualEnrollment>>()
				{
					@Override
					public List<IndividualEnrollment> call(
							ServiceResponseWithHeaders<List<IndividualEnrollment>, QueryIndividualEnrollmentsHeaders> response)
					{
						return response.body();
					}
				});
	 ...
	 * @return the observable to the List&lt;IndividualEnrollment&gt; object
	 */
	public Observable<ServiceResponseWithHeaders<List<IndividualEnrollment>, QueryIndividualEnrollmentsHeaders>> queryIndividualEnrollmentsWithServiceResponseAsync(
			QuerySpecification querySpecification)
	{
		...
		return service
				.queryIndividualEnrollments(xMsMaxItemCount, xMsContinuation, querySpecification, this.apiVersion())
				.flatMap(
						new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<List<IndividualEnrollment>, QueryIndividualEnrollmentsHeaders>>>()
						{
							@Override
							public Observable<ServiceResponseWithHeaders<List<IndividualEnrollment>, QueryIndividualEnrollmentsHeaders>> call(
									Response<ResponseBody> response)
							{
								try
								{
									ServiceResponseWithHeaders<List<IndividualEnrollment>, QueryIndividualEnrollmentsHeaders> clientResponse = queryIndividualEnrollmentsDelegate(
											response);
									return Observable.just(clientResponse);
								}
								catch (Throwable t)
	...
	{
		return queryIndividualEnrollmentsWithServiceResponseAsync(querySpecification, xMsMaxItemCount, xMsContinuation)
	...
	{
		return ServiceFuture.fromHeaderResponse(queryIndividualEnrollmentsWithServiceResponseAsync(querySpecification,
				xMsMaxItemCount, xMsContinuation), serviceCallback);
	}
	...
	{
		return queryIndividualEnrollmentsWithServiceResponseAsync(querySpecification, xMsMaxItemCount, xMsContinuation)
				.map(new Func1<ServiceResponseWithHeaders<List<IndividualEnrollment>, QueryIndividualEnrollmentsHeaders>, List<IndividualEnrollment>>()
				{
					@Override
					public List<IndividualEnrollment> call(
							ServiceResponseWithHeaders<List<IndividualEnrollment>, QueryIndividualEnrollmentsHeaders> response)
	...
	private ServiceResponseWithHeaders<List<IndividualEnrollment>, QueryIndividualEnrollmentsHeaders> queryIndividualEnrollmentsDelegate(
			Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<List<IndividualEnrollment>, ProvisioningServiceErrorDetailsException>newInstance(
						this.serializerAdapter())
				.register(200, new TypeToken<List<IndividualEnrollment>>()
				{
				}.getType()).registerError(ProvisioningServiceErrorDetailsException.class)
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<AttestationMechanism> getIndividualEnrollmentAttestationMechanismAsync(String id,
			final ServiceCallback<AttestationMechanism> serviceCallback)
	{
		return ServiceFuture.fromResponse(getIndividualEnrollmentAttestationMechanismWithServiceResponseAsync(id),
				serviceCallback);
	}
	...
	{
		return getIndividualEnrollmentAttestationMechanismWithServiceResponseAsync(id)
				.map(new Func1<ServiceResponse<AttestationMechanism>, AttestationMechanism>()
				{
					@Override
	 ...
	 * @return the observable to the AttestationMechanism object
	 */
	public Observable<ServiceResponse<AttestationMechanism>> getIndividualEnrollmentAttestationMechanismWithServiceResponseAsync(
			String id)
	{
		if (id == null)
		{
		...
		return service.getIndividualEnrollmentAttestationMechanism(id, this.apiVersion())
				.flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<AttestationMechanism>>>()
				{
					...
					public Observable<ServiceResponse<AttestationMechanism>> call(Response<ResponseBody> response)
					{
						try
						{
							ServiceResponse<AttestationMechanism> clientResponse = getIndividualEnrollmentAttestationMechanismDelegate(
									response);
							return Observable.just(clientResponse);
						}
						catch (Throwable t)
	...
	private ServiceResponse<AttestationMechanism> getIndividualEnrollmentAttestationMechanismDelegate(
			Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<AttestationMechanism, ProvisioningServiceErrorDetailsException>newInstance(this.serializerAdapter())
				.register(200, new TypeToken<AttestationMechanism>()
				{
				}.getType()).registerError(ProvisioningServiceErrorDetailsException.class).build(response);
	}
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<List<EnrollmentGroup>> queryEnrollmentGroupsAsync(QuerySpecification querySpecification,
			final ServiceCallback<List<EnrollmentGroup>> serviceCallback)
	{
		return ServiceFuture.fromHeaderResponse(queryEnrollmentGroupsWithServiceResponseAsync(querySpecification),
				serviceCallback);
	}
	...
	{
		return queryEnrollmentGroupsWithServiceResponseAsync(querySpecification).map(
				new Func1<ServiceResponseWithHeaders<List<EnrollmentGroup>, QueryEnrollmentGroupsHeaders>, List<EnrollmentGroup>>()
				{
					@Override
					public List<EnrollmentGroup> call(
							ServiceResponseWithHeaders<List<EnrollmentGroup>, QueryEnrollmentGroupsHeaders> response)
					{
						return response.body();
					}
				});
	 ...
	 * @return the observable to the List&lt;EnrollmentGroup&gt; object
	 */
	public Observable<ServiceResponseWithHeaders<List<EnrollmentGroup>, QueryEnrollmentGroupsHeaders>> queryEnrollmentGroupsWithServiceResponseAsync(
			QuerySpecification querySpecification)
	{
		if (querySpecification == null)
		{
		...
		return service.queryEnrollmentGroups(xMsMaxItemCount, xMsContinuation, querySpecification, this.apiVersion())
				.flatMap(
						new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<List<EnrollmentGroup>, QueryEnrollmentGroupsHeaders>>>()
						{
							@Override
							public Observable<ServiceResponseWithHeaders<List<EnrollmentGroup>, QueryEnrollmentGroupsHeaders>> call(
									Response<ResponseBody> response)
							{
								try
								{
									ServiceResponseWithHeaders<List<EnrollmentGroup>, QueryEnrollmentGroupsHeaders> clientResponse = queryEnrollmentGroupsDelegate(
											response);
									return Observable.just(clientResponse);
								}
								catch (Throwable t)
	 ...
	 * @return the List&lt;EnrollmentGroup&gt; object if successful.
	 */
	public List<EnrollmentGroup> queryEnrollmentGroups(QuerySpecification querySpecification, Integer xMsMaxItemCount,
			String xMsContinuation)
	{
		return queryEnrollmentGroupsWithServiceResponseAsync(querySpecification, xMsMaxItemCount, xMsContinuation)
				.toBlocking().single().body();
	}
	...
	public ServiceFuture<List<EnrollmentGroup>> queryEnrollmentGroupsAsync(QuerySpecification querySpecification,
			...
			final ServiceCallback<List<EnrollmentGroup>> serviceCallback)
	{
		return ServiceFuture.fromHeaderResponse(
				queryEnrollmentGroupsWithServiceResponseAsync(querySpecification, xMsMaxItemCount, xMsContinuation),
				serviceCallback);
	}
	...
	public Observable<List<EnrollmentGroup>> queryEnrollmentGroupsAsync(QuerySpecification querySpecification,
			Integer xMsMaxItemCount, String xMsContinuation)
	{
		return queryEnrollmentGroupsWithServiceResponseAsync(querySpecification, xMsMaxItemCount, xMsContinuation).map(
				new Func1<ServiceResponseWithHeaders<List<EnrollmentGroup>, QueryEnrollmentGroupsHeaders>, List<EnrollmentGroup>>()
				{
					@Override
					public List<EnrollmentGroup> call(
	...
	private ServiceResponseWithHeaders<List<EnrollmentGroup>, QueryEnrollmentGroupsHeaders> queryEnrollmentGroupsDelegate(
			Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<List<EnrollmentGroup>, ProvisioningServiceErrorDetailsException>newInstance(this.serializerAdapter())
				.register(200, new TypeToken<List<EnrollmentGroup>>()
				{
				}.getType()).registerError(ProvisioningServiceErrorDetailsException.class)
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<AttestationMechanism> getEnrollmentGroupAttestationMechanismAsync(String id,
			final ServiceCallback<AttestationMechanism> serviceCallback)
	{
		return ServiceFuture.fromResponse(getEnrollmentGroupAttestationMechanismWithServiceResponseAsync(id),
				serviceCallback);
	}
	...
	{
		return getEnrollmentGroupAttestationMechanismWithServiceResponseAsync(id)
				.map(new Func1<ServiceResponse<AttestationMechanism>, AttestationMechanism>()
				{
					@Override
					public AttestationMechanism call(ServiceResponse<AttestationMechanism> response)
	 ...
	 * @return the observable to the AttestationMechanism object
	 */
	public Observable<ServiceResponse<AttestationMechanism>> getEnrollmentGroupAttestationMechanismWithServiceResponseAsync(
			String id)
	{
		if (id == null)
		{
		...
		return service.getEnrollmentGroupAttestationMechanism(id, this.apiVersion())
				.flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<AttestationMechanism>>>()
				{
					...
					public Observable<ServiceResponse<AttestationMechanism>> call(Response<ResponseBody> response)
					{
						try
						{
							ServiceResponse<AttestationMechanism> clientResponse = getEnrollmentGroupAttestationMechanismDelegate(
									response);
							return Observable.just(clientResponse);
						}
						catch (Throwable t)
	...
	private ServiceResponse<AttestationMechanism> getEnrollmentGroupAttestationMechanismDelegate(
			Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
	 ...
	 * @return the {@link ServiceFuture} object
	 */
	public ServiceFuture<List<DeviceRegistrationState>> queryDeviceRegistrationStatesAsync(String id,
	...
	{
		return queryDeviceRegistrationStatesWithServiceResponseAsync(id)
				.map(new Func1<ServiceResponse<List<DeviceRegistrationState>>, List<DeviceRegistrationState>>()
				{
					@Override
	 ...
	 * @return the observable to the List&lt;DeviceRegistrationState&gt; object
	 */
	public Observable<ServiceResponse<List<DeviceRegistrationState>>> queryDeviceRegistrationStatesWithServiceResponseAsync(
			String id)
	{
		if (id == null)
		{
		...
		return service.queryDeviceRegistrationStates(id, this.apiVersion())
				...
				{
					@Override
					public Observable<ServiceResponse<List<DeviceRegistrationState>>> call(
							Response<ResponseBody> response)
					{
						try
						{
							ServiceResponse<List<DeviceRegistrationState>> clientResponse = queryDeviceRegistrationStatesDelegate(
									response);
							return Observable.just(clientResponse);
						}
						catch (Throwable t)
	...
	private ServiceResponse<List<DeviceRegistrationState>> queryDeviceRegistrationStatesDelegate(
			Response<ResponseBody> response)
			throws ProvisioningServiceErrorDetailsException, IOException, IllegalArgumentException
	{
		return this.restClient().responseBuilderFactory()
				.<List<DeviceRegistrationState>, ProvisioningServiceErrorDetailsException>newInstance(
						this.serializerAdapter())
				.register(200, new TypeToken<List<DeviceRegistrationState>>()
				{
				}.getType()).registerError(ProvisioningServiceErrorDetailsException.class).build(response);
	}

...
public class EnrollmentGroup
{
	 ...
	 * level allocation policy for this individual enrollment or enrollment group.
	 * Possible values include 'hashed': Linked IoT hubs are equally likely to have
	 * devices provisioned to them, 'geoLatency': Devices are provisioned to an IoT
	 * hub with the lowest latency to the device.If multiple linked IoT hubs would
	 * provide the same lowest latency, the provisioning service hashes devices
	 * across those hubs, 'static' : Specification of the desired IoT hub in the
	 * enrollment list takes priority over the service-level allocation policy,
	 ...
	 * initial configuration. We recommend using Azure Functions to host your logic.
	...
	/**
	 * The list of names of IoT hubs the device(s) in this resource can be allocated
	 * to. Must be a subset of tenant level list of IoT hubs.
	 */
	...
	/**
	 * Get the allocation policy of this resource. This policy overrides the tenant
	 * level allocation policy for this individual enrollment or enrollment group.
	 * Possible values include 'hashed': Linked IoT hubs are equally likely to have
	 * devices provisioned to them, 'geoLatency': Devices are provisioned to an IoT
	 * hub with the lowest latency to the device.If multiple linked IoT hubs would
	...
	/**
	 * Set the allocation policy of this resource. This policy overrides the tenant
	 * level allocation policy for this individual enrollment or enrollment group.
	 * Possible values include 'hashed': Linked IoT hubs are equally likely to have
	 * devices provisioned to them, 'geoLatency': Devices are provisioned to an IoT
	 * hub with the lowest latency to the device.If multiple linked IoT hubs would
	...
	/**
	 * Get the list of names of IoT hubs the device(s) in this resource can be
	...
	/**
	 * Set the list of names of IoT hubs the device(s) in this resource can be
	 * allocated to. Must be a subset of tenant level list of IoT hubs.
	 *

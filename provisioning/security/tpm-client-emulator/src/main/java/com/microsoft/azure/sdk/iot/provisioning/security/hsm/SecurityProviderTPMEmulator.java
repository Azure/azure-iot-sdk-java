...
public class SecurityProviderTPMEmulator extends SecurityProviderTpm
{
    ...
    public SecurityProviderTPMEmulator() throws SecurityClientException
    {
    ...
    private TPMT_PUBLIC createPersistentPrimary(Tpm tpm, TPM_HANDLE hPersistent, TPM_RH hierarchy, TPMT_PUBLIC inPub, String primaryRole) throws SecurityClientException
    {
        ...
        if (rpResp == null)
        {
            throw new SecurityClientException("rpResp cannot be null");
        }
        ...
        if (cpResp == null)
        {
            throw new SecurityClientException("cpResp cannot be null");
        }
    ...
    public byte[] activateIdentityKey(byte[] key) throws SecurityClientException
    {
        ...
        if (sasResp == null)
        {
            throw new SecurityClientException("sasResp cannot be null");
        }
        ...
        if (crResp == null)
        {
            throw new SecurityClientException("crResp cannot be null");
        }
        ...
        if (edResp == null)
        {
            throw new SecurityClientException("edResp cannot be null");
        }

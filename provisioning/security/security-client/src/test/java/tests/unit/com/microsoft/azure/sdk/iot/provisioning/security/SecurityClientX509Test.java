...
/*
 *  Unit tests for SecurityClientX509 and SecurityClient
 *  Coverage : 97% lines, 100% methods
 */
public class SecurityClientX509Test
{
    ...
    class SecurityClientX509TestImpl extends SecurityClientX509
    {
        private String cn;
        ...
        SecurityClientX509TestImpl(String cn, X509Certificate x509Certificate, Key key, Collection<X509Certificate> certificates)
        {
            this.cn = cn;
    ...
    public void getRegistrationIdSucceeds() throws SecurityClientException
    {
        ...
        SecurityClientX509 securityClientX509Test = new SecurityClientX509TestImpl(TEST_COMMON_NAME, mockedX509Certificate, mockedKey, certificates);
    ...
    public void getSslContextThrowsOnNullLeaf() throws SecurityClientException, KeyManagementException, KeyStoreException
    {
        ...
        SecurityClientX509 securityClientX509Test = new SecurityClientX509TestImpl(TEST_COMMON_NAME, null, mockedKey, certificates);
    ...
    public void getSslContextThrowsOnNullPrivateKey() throws SecurityClientException, KeyManagementException, KeyStoreException
    {
        ...
        SecurityClientX509 securityClientX509Test = new SecurityClientX509TestImpl(TEST_COMMON_NAME, mockedX509Certificate, null, certificates);
    ...
    {
        //arrange
        SecurityClientX509 securityClientX509Test = new SecurityClientX509TestImpl(TEST_COMMON_NAME, mockedX509Certificate, mockedKey, null);

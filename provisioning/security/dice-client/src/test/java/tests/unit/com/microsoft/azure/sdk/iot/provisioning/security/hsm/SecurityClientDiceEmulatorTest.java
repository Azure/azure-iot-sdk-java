...
public class SecurityClientDiceEmulatorTest
{
    ...
    public void getterForCommonNameSucceeds() throws Exception
    {
        ...
        SecurityClientDiceEmulator testSecurityClientDiceEmulator = new SecurityClientDiceEmulator(TEST_ALIAS,
                                                                                                   ...
                                                                                                   TEST_ROOT);
        //act
        String cName = testSecurityClientDiceEmulator.getDeviceCommonName();

        //assert
        assertEquals(cName, TEST_ROOT);
    }
    ...
    public void getterForAliasCertSucceeds() throws Exception
    {
        ...
        SecurityClientDiceEmulator testSecurityClientDiceEmulator = new SecurityClientDiceEmulator(TEST_ALIAS,
                                                                                                   ...
                                                                                                   TEST_ROOT);
        //act
        Certificate cert = testSecurityClientDiceEmulator.getAliasCert();
    ...
    public void getterForAliasKeySucceeds() throws Exception
    {
        ...
        SecurityClientDiceEmulator testSecurityClientDiceEmulator = new SecurityClientDiceEmulator(TEST_ALIAS,
                                                                                                   ...
                                                                                                   TEST_ROOT);
        //act
        Key aliasKey = testSecurityClientDiceEmulator.getAliasKey();
    ...
    @Test
    public void getterForDeviceSignerSucceeds() throws Exception
    {
        //arrange
        SecurityClientDiceEmulator testSecurityClientDiceEmulator = new SecurityClientDiceEmulator(TEST_ALIAS,
                                                                                                   TEST_SIGNER,
                                                                                                   TEST_ROOT);
        //act
        Certificate cert = testSecurityClientDiceEmulator.getDeviceSignerCert();

...
your physical device's certificate store, simply installing the DigiCert Global G2 CA root isn't sufficient to handle this
transition. There are two ways to ensure that your device using this SDK can continue to connect to the service once this transition starts:

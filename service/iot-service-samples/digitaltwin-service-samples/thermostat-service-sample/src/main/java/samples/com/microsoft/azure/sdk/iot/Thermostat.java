                ...
                .subscribe(
                        ...
                        error ->
                        {
                            ...
                            if(ex.response().code() == 404) {
                                ...
                                System.out.println("Ensure the device sample is running for this sample to succeed - https://github.com/Azure/azure-iot-sdk-java/tree/master/device/iot-device-samples/pnp-device-sample/thermostat-device-sample.");
                            }
                            latch.countDown();
                        });

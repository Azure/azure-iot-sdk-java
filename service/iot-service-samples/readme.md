...
3. Running the Device Manager Sample application:
   ...
   ```
   mvn exec:java -Dexec.mainClass="samples.com.microsoft.azure.sdk.iot.service.DeviceManagerSample"
   ```
...
3. Running the Service Client Sample application:
    ...
    ```
    mvn exec:java -Dexec.mainClass="samples.com.microsoft.azure.sdk.iot.service.ServiceClientSample"
    ```

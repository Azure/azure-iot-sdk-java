...
* [Digital Twin samples](https://github.com/Azure/azure-iot-sdk-java/tree/preview/service/iot-service-samples/digitaltwin-service-samples): Shows how to use the DigitalTwinClient to perform server-side operations on plug-and-play compatible devices.
...
> Note: This sample requires the device sample to be running - [Thermostat Device Sample](https://github.com/Azure/azure-iot-sdk-java/tree/preview/device/iot-device-samples/pnp-device-sample/thermostat-device-sample)
<br/>
...
> Note: This sample requires the device sample to be running - [TemperatureController Device Sample](https://github.com/Azure/azure-iot-sdk-java/tree/preview/device/iot-device-samples/pnp-device-sample/temperature-controller-device-sample)
<br/>

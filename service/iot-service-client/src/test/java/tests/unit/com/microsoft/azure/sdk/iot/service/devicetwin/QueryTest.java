...
public class QueryTest
{
    ...
    @Test (expected = IllegalArgumentException.class)
    public void constructorThrowsOnNullQueryType() throws IllegalArgumentException
    {
        //arrange
        final String sqlQuery = DEFAULT_QUERY;
    ...
    public void sendQueryRequestThrowsWhenResponseThrows(@Mocked IotHubConnectionString mockIotHubConnectionString,
                                                                    @Mocked URL mockUrl,
                                                                    @Mocked HttpResponse mockHttpResponse,
                                                                    @Mocked HttpRequest mockHttpRequest,
                                                                    @Mocked QueryResponse mockedQueryResponse,

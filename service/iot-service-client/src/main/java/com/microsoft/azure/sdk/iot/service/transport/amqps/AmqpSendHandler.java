...
public class AmqpSendHandler extends AmqpConnectionHandler
{
    ...
    AmqpSendHandler(String hostName, TokenCredential tokenProvider, AuthenticationType authorizationType, IotHubServiceClientProtocol iotHubServiceClientProtocol, ProxyOptions proxyOptions, SSLContext sslContext)
    {

...
public class QueryCollection
{
    ...
    protected QueryCollection(String query, int pageSize, QueryType requestQueryType, IotHubConnectionString iotHubConnectionString, URL url, HttpMethod httpMethod, long timeout)
    {
        ...
        this.tokenCredential = new IotHubConnectionStringCredential(iotHubConnectionString.toString());
    ...
    QueryCollection(String query, int pageSize, QueryType requestQueryType, String hostName, TokenCredential tokenCredential, TokenCredentialType tokenCredentialType, URL url, HttpMethod httpMethod, int httpConnectTimeout, int httpReadTimeout, Proxy proxy)
    {
        this.pageSize = pageSize;
        this.requestQueryType = requestQueryType;
        this.query = query;
    ...
    private QueryCollectionResponse<String> sendQueryRequest(QueryOptions options) throws IOException, IotHubException
    {
        ...
        HttpResponse httpResponse = DeviceOperations.request(this.tokenCredential, this.tokenCredentialType, this.url, this.httpMethod, payload, null, this.httpConnectTimeout, this.httpReadTimeout, this.proxy);

...
public abstract class DPSSecurityClientX509 implements DPSSecurityClient
{
    ...
    {
        if (type != SecurityType.X509)
            throw new IllegalArgumentException("Type can be X509 only");

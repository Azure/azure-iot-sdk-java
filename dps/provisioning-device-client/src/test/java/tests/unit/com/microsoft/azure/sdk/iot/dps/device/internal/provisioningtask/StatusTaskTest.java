...
public class StatusTaskTest
{
    ...
    public void constructorSucceeds() throws ProvisioningDeviceClientException
    {
        //arrange
        //act
        StatusTask statusTask = Deencapsulation.newInstance(StatusTask.class, new Class[] {DPSSecurityClient.class,
        ...
        //assert
        assertNotNull(Deencapsulation.getField(statusTask, "dpsSecurityClient"));
    ...
    public void getRegistrationStatusSucceeds() throws Exception
    {
        ...
        {
            {
                mockedDpsSecurityClient.getRegistrationId();

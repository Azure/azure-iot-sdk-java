...
public class ProvisioningTask implements Callable
{
     ...
     * @param dpsSecurityClient Security client that holds information about device authentication
    ...
    {
        RegisterTask registerTask = new RegisterTask(this.provisioningDeviceClientConfig, dpsSecurityClient,
                                                                   ...
                                                                   ProvisioningDeviceClientException
    {
        ...
        StatusTask statusTask = new StatusTask(dpsSecurityClient, provisioningDeviceClientContract, operationId,
                                               this.authorization);
    ...
    {
        //ProvisioningStatus nextStatus = ASSIGNING;
        ...
        do
        {
            ...
            {
                case UNASSIGNED:
                    if (ProvisioningStatus.fromString(statusResponseParser.getStatus()) == ProvisioningStatus.UNASSIGNED)
                    {

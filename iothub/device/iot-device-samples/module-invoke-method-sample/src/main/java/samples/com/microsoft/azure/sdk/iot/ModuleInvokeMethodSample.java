...
public class ModuleInvokeMethodSample
{
    ...
    public static void main(String[] args) throws IOException, URISyntaxException, IotHubClientException
    {
        ...
        // Please also refer to https://github.com/Azure/azure-iot-sdk-java/blob/main/iothub/device/iot-device-client/src/main/java/com/microsoft/azure/sdk/iot/device/edge/DirectMethodRequest.java

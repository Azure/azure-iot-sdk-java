...
public final class ProvisioningSasToken
{
	 ...
	 * signature the resource URI the expiry time the key name Example:
	 * {@code SharedAccessSignature sr=DEVICEPROVISIONINGSERVICEURI&sig=SIGNATURE&se=EXPIRY&skn=SHAREDACCESSKEYNAME}
	 */
	 ...
	 *
	 * @param provisioningConnectionString Connection string object containing the
	 *                                     connection parameters
	 * @throws IllegalArgumentException if the provided provisioning connection
	 *                                  string is null
	 */
	public ProvisioningSasToken(ProvisioningConnectionString provisioningConnectionString)
			throws IllegalArgumentException
	{
		// Codes_SRS_PROVISIONING_SERVICE_SASTOKEN_12_001: [The constructor shall throw
		// IllegalArgumentException if the input object is null]
		if (provisioningConnectionString == null)
		{
			throw new IllegalArgumentException("provisioningConnectionString is null");
		}
		// Codes_SRS_PROVISIONING_SERVICE_SASTOKEN_12_002: [The constructor shall create
		// a target uri from the url encoded host name)]
		// Codes_SRS_PROVISIONING_SERVICE_SASTOKEN_12_003: [The constructor shall create
		// a string to sign by concatenating the target uri and the expiry time string
		// (one year)]
		...
		// using the format: "SharedAccessSignature sr=%s&sig=%s&se=%s&skn=%s"]
	...
	private String buildToken()
	{
		...
		else
		{
			...
			{
				// Codes_SRS_PROVISIONING_SERVICE_SASTOKEN_12_007: [The constructor shall throw
				// Exception if building the token failed]
	...
	{
		// Codes_SRS_PROVISIONING_SERVICE_SASTOKEN_12_008: [The constructor shall return

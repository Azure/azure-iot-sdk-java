...
/**
 * Expose all connections string properties and methods for user, device and
 * connection string serialization.
 */
public class ProvisioningConnectionString extends ProvisioningConnectionStringBuilder
{
	 ...
	 *
	 * @return The user string in the following format:
	 *         "SharedAccessKeyName@SAS.root.deviceProvisioningServiceName"
	 */
	public String getUserString()
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_001: [The getUserString shall
		 * serialize the object properties to a string using the following format:
		 * SharedAccessKeyName@SAS.root.deviceProvisioningServiceName]
		 */
	...
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_002: [The toString shall serialize
		 * the object to a string using the following format:
		 * HostName=HOSTNAME.b.c.d;SharedAccessKeyName=ACCESSKEYNAME;SharedAccessKey=
		 * 1234567890abcdefghijklmnopqrstvwxyz=;SharedAccessSignature=]
		 */
		StringBuilder stringBuilder = new StringBuilder();
	...
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_003: [The
		 * getDeviceProvisioningServiceName shall return the stored
	...
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_004: [The getAuthenticationMethod
		 * shall return the stored authenticationMethod.]
		 */
	...
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_005: [The getSharedAccessKeyName
		 * shall return the stored sharedAccessKeyName.]
		 */
	...
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_006: [The getSharedAccessKey shall
		 * return the stored sharedAccessKey.]
		 */
	...
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_007: [The getSharedAccessSignature
		 * shall return the stored sharedAccessSignature.]
		 */
	...
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_008: [The getHostName shall return
		 * the stored hostName.]
		 */
	...
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_009: [The setSharedAccessKeyName
		 * shall update the sharedAccessKeyName by the provided one.]
		 */
	...
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_010: [The setSharedAccessKey shall
		 * update the sharedAccessKey by the provided one.]
		 */
	...
	{
		/*
		 * Codes_SRS_PROVISIONINGCONNECTIONSTRING_21_011: [The setSharedAccessSignature
		 * shall update the sharedAccessSignature by the provided one.]
		 */
